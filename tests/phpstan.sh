...
docker exec -tid temp-ps rm -rf /var/www/html/modules/pssentry
...
docker run --rm --volumes-from temp-ps \
       -v $PWD:/var/www/html/modules/pssentry \
       -e _PS_ROOT_DIR_=/var/www/html \
       --workdir=/var/www/html/modules/pssentry phpstan/phpstan:0.12 \
       analyse \
       --configuration=/var/www/html/modules/pssentry/tests/phpstan/phpstan-$PS_VERSION.neon